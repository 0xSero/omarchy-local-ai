...
RUNTIME = manifest.json recipes.json LICENSE Panel.qml Model.js lfm.svg qwen.svg bin/omarchy-local-ai bin/omarchy-install-ai-local bin/omarchy-remove-ai-local
