...
- The card shows a running operation until it ends; navigating away during a load, the verb queue, the home model picker, toasts, Ctrl+O and the page keys are gone. Same views, same rows.
