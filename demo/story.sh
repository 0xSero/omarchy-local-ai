...
step pi       9  40 "Run lspci | grep -i arc and curl -s -H @~/.local/state/omarchy/local-ai/gateway.auth http://127.0.0.1:12434/v1/models. Then tell me in two lines what hardware and which model you are running on."
